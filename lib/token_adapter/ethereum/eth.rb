  ...
  module Ethereum
    ...
    class Eth < TokenAdapter::Base
      ...
      def getnewaddress(account, passphrase)
        ...
        txhash = send_transaction(exchange_address, nil, data, gas_limit, gas_price, to)
      ...
      def sendtoaddress(address, amount)
        ...
        personal_unlock_account(exchange_address, exchange_address_passphrase)
        send_transaction(exchange_address, amount, nil, gas_limit, gas_price, address)
      end
      ...
      def wallet_collect(wallet_address, token_address, amount, token_decimals)
        ...
        personal_unlock_account(exchange_address, exchange_address_passphrase)
        txhash = send_transaction(exchange_address, nil, data, gas_limit, gas_price, wallet_address)
        return nil unless txhash
